...
Uz_Globs *globalsCtor    ();                            /* globals.c */
...
int      dateformat      ();                                /* local */
char     dateseparator   ();                                /* local */
#ifndef WINDLL
   void  version         ();                              /* local */
#endif
int      mapattr         ();                              /* local */
...
# endif
   ...
   void  prepare_ISO_OEM_translat   ();                   /* local */
#endif
   ...
   void  SYSTEM_SPECIFIC_CTOR   ();                       /* local */
#endif
#ifdef SYSTEM_SPECIFIC_DTOR
   void  SYSTEM_SPECIFIC_DTOR   ();                       /* local */
#endif
